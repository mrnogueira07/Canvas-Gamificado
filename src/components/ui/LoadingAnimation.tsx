        ...
        <div className="flex flex-col items-center justify-center p-8 text-center h-full min-h-[500px]">
            ...
            <div className="space-y-4 max-w-sm">
                ...
                >
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">IA Cognitiva Ativa</span>
                </motion.div>
                ...
                <p className="text-slate-500 text-sm leading-relaxed font-medium">
                    Nossa inteligência artificial está transformando seus dados em um <span className="text-indigo-500 font-bold">planejamento gamificado</span> épico e memorável.
                </p>
